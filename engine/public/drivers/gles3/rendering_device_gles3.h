...
namespace golias {
    ...
    private:
        ...
        std::unordered_map<RID, ShaderData> shaders;
        std::unordered_map<RID, BufferData> buffers;
        std::unordered_map<RID, TextureData> textures;
        std::unordered_map<RID, SamplerData> samplers;
        std::unordered_map<RID, FramebufferData> framebuffers;
        std::unordered_map<RID, PipelineData> pipelines;
